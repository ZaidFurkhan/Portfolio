export default function Hero({ className }) {
    return (
        <section id="home" className={`relative overflow-hidden w-full h-[100vh] bg-gradient-to-r from-gray-300 via-gray-200 to-gray-50 text-black flex items-end pb-20 justify-start animate-in slide-in-from-bottom duration-800 px-8 gap-10 pb-50 md:pb-25 md:pt-32 ${className}`}  >
            ...
            <div className="absolute bottom-0 right-0 pointer-events-none -z-10 opacity-45">
